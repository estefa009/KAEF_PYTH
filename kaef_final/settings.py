"""
Django settings for kaef_final project.
...
SECRET_KEY = 'django-insecure-0r6ft(+c5u4r$d@uyi)vjl&)+ir%8tvj9ov^jys^0!!u+i+^l9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sdnts.context_processors.carrito',  # Asegúrate de que este contexto esté definido
            ],
        },
    },
]

WSGI_APPLICATION = 'kaef_final.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'sdnts', 'static'),
    os.path.join(BASE_DIR, 'sdnts', 'static', 'font'), 
]
