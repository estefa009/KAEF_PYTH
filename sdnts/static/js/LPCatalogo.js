...
// Funciones para manejar el modal de Talla XL
const btnInfoXL = document.getElementById('btnInfoXL');
...
// Función para abrir el modal de Talla XL
if (btnInfoXL) {
    btnInfoXL.addEventListener('click', () => {
        modalXL.classList.remove('hidden'); // Muestra el modal
    });
}

// Función para cerrar el modal de Talla XL
const cerrarModalXL = () => {
    modalXL.classList.add('hidden'); // Oculta el modal
};

// Añadir eventos para cerrar el modal de Talla XL
if (closeXL) {
    closeXL.addEventListener('click', cerrarModalXL);
}
if (btnCerrarModalXL) {
    btnCerrarModalXL.addEventListener('click', cerrarModalXL);
}
